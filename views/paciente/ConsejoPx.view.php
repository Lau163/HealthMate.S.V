...
<body class="bg-gray-100 overflow-hidden">
  ...
  <div class="w-[755px] h-[512px] left-[578px] top-[180px] absolute bg-stone-300/30"></div>
  ...
  <div class="w-[1309px] h-0 left-[65px] top-[138px] absolute outline outline-2 outline-offset-[-1px] outline-stone-400/90"></div>
  <div class="w-44 h-11 left-[1048px] top-[752px] absolute bg-teal-700 rounded-[10px]"></div>
  ...
  <div class="w-44 h-10 left-[228px] top-[752px] absolute bg-teal-700 rounded-[10px]"></div>
