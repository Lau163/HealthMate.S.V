...
// Obtener historial médico desde el controlador
$historial = $historial ?? [
    ['id' => 1, 'fecha' => '15-10-2024', 'diagnostico' => 'Hipertensión', 'descripcion' => 'El px presenta hipertensión tras toma de S.V.', 'tratamiento' => 'Checar P.A una vez al día durante 7 días', 'signos_vitales' => ['presion_arterial' => '150/95 mmHg', 'frecuencia_cardiaca' => '78 bpm', 'temperatura' => '36.5°C', 'peso' => '75 kg'], 'estado' => 'Activo'],
    ['id' => 2, 'fecha' => '08-09-2024', 'diagnostico' => 'Amigdalitis', 'descripcion' => 'Px con febrícula e inflamación en garganta', 'tratamiento' => 'Loratadina 1 c/24 hrs por 3 días. Paracetamol 1 c/8 hrs', 'signos_vitales' => ['presion_arterial' => '130/85 mmHg', 'frecuencia_cardiaca' => '82 bpm', 'temperatura' => '38.2°C', 'peso' => '74 kg'], 'estado' => 'Completado']
];

// Información del doctor desde el controlador
$doctor = $doctor ?? [
...
<!-- Historial Clínico Content -->
<div class="space-y-6">
    <!-- Header Section -->
    <div class="bg-gradient-to-r from-red-500 to-pink-600 rounded-lg shadow-lg p-8 text-white">
    ...
    <div class="bg-white rounded-lg shadow-sm">
        <div class="border-b border-gray-200">
            <nav class="flex space-x-8 px-6" aria-label="Tabs">
                ...
                <a href="<?php echo BASE_URL; ?>doctor/perfil?debug=1" class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                    <i class="fas fa-user mr-2"></i>Perfil del Paciente
                </a>
                <a href="<?php echo BASE_URL; ?>doctor/consultas?debug=1" class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                    <i class="fas fa-calendar-alt mr-2"></i>Consultas
                </a>
                <a href="<?php echo BASE_URL; ?>doctor/recetas?debug=1" class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
    ...
    <div class="flex justify-center space-x-4">
        ...
        <button onclick="location.href='<?php echo BASE_URL; ?>doctor/?debug=1'"
