...
<div class="w-[1440px] h-[900px] relative bg-white overflow-hidden">
  ...
  <div class="left-[149px] top-[283px] absolute justify-start text-black text-xl font-bold font-['Roboto']">Pacientes</div>
  <div class="left-[149px] top-[339px] absolute justify-start text-stone-900 text-xl font-bold font-['Roboto']">Agenda De Consultas</div>
  <div class="w-28 left-[128px] top-[387px] absolute text-center justify-start text-stone-900 text-xl font-bold font-['Roboto']">Recetas</div>
  ...
  <div class="left-[393px] top-[47px] absolute justify-start text-white text-2xl font-bold font-['Roboto']">MEDICO</div>
  ...
  <div class="left-[530px] top-[379px] absolute justify-start text-black text-xl font-bold font-['Roboto']">Jose Mendoza</div>
  <div class="left-[489px] top-[425px] absolute justify-start text-black text-base font-black font-['Roboto']">CEDULA </div>
  <div class="left-[489px] top-[470px] absolute justify-start text-black text-base font-black font-['Roboto']">ESPECIALIDADES</div>
  <div class="left-[489px] top-[514px] absolute justify-start text-black text-base font-black font-['Roboto']">TELÉFONO</div>
  <div class="left-[489px] top-[556px] absolute justify-start text-black text-base font-black font-['Roboto']">EMAIL</div>
  <div class="left-[566px] top-[424px] absolute justify-start text-zinc-700 text-base font-black font-['Roboto']">CD8957552</div>
  <div class="left-[626px] top-[467px] absolute justify-start text-zinc-700 text-base font-black font-['Roboto']">Medico cirujano</div>
  ...
  <div class="left-[892px] top-[175px] absolute justify-start text-black text-2xl font-bold font-['Roboto']">Mi Perfil</div>
