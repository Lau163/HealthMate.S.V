    ...
    <div class="min-h-screen flex flex-col">
        ...
        <nav class="bg-teal-700 text-white p-4 shadow-md">
            <div class="container mx-auto flex justify-between items-center">
                <a href="<?= BASE_URL ?>doctor" class="text-2xl font-bold">
        ...
        <main class="flex-grow container mx-auto p-6">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <form action="<?= BASE_URL ?>doctor/registrar-paciente" method="POST" class="space-y-6">
                    ...
                    <div class="flex justify-end space-x-4 pt-6 border-t">
                        <a href="<?= BASE_URL ?>doctor" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">
