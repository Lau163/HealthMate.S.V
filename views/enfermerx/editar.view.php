<?php
// views/enfermerx/editar.view.php

$enfermerx = $this->get('enfermerex') ?? [];
$error = $_SESSION['error'] ?? '';
unset($_SESSION['error']);
$success = $_SESSION['success'] ?? '';
unset($_SESSION['success']);

$id = htmlspecialchars($enfermerx['Id_Usuario'] ?? '', ENT_QUOTES, 'UTF-8');
?>
    ...
    <div class="col-lg-8">
      <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
          <h5 class="mb-0">Editar enfermerx #<?php echo $id; ?></h5>
        </div>
        <div class="card-body">
          <?php if ($error): ?>
          ...
          <form action="<?php echo BASE_URL; ?>enfermerx/editar/<?php echo $id; ?>" method="post" class="row g-3" novalidate>
            <div class="col-md-6">
            ...
            <div class="col-md-4">
              ...
              <select id="Sexo" name="Sexo" class="form-select">
                <?php $sexo = strtolower($enfermerx['Sexo'] ?? ''); ?>
            ...
            <div class="col-12 d-flex justify-content-between mt-3">
              <a href="<?php echo BASE_URL; ?>enfermerx" class="btn btn-outline-secondary">Cancelar</a>
